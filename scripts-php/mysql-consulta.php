...
if(isset($_POST['buscar_paciente'])){
	if(strlen($_POST['paciente_nombre']) && strlen($_POST['fecha_1consulta'])){
		...
		if($datos_paciente->num_rows > 0){
			...
			$fecha_1consulta = $fila['fecha_1consulta'];
			$paciente_tel = $fila['paciente_tel'];
			$paciente_tel_tipo = $fila['paciente_tel_tipo'];
			$paciente_email = $fila['paciente_email'];
			$paciente_direccion = $fila['paciente_direccion'];
			$paciente_fecha_nac = $fila['paciente_fecha_nac'];
			$paciente_edad = $fila['paciente_edad'];
			$paciente_hijos_status = $fila['paciente_hijos_status'];
			$paciente_ocupacion = $fila['paciente_ocupacion'];
			$paciente_nombre_comun = $fila['paciente_nombre_comun'];
			$APP_TX = $fila['APP-TX'];
			$HEA = $fila['HEA'];
			$AHF = $fila['AHF'];
			$APNP = $fila['APNP'];
